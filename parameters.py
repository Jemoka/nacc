...
parser.add_argument("--checkpoint_interval", default=128, type=int, help="checkpoint every this many steps")
parser.add_argument("--validation_interval", default=128, type=int, help="validate every this many steps")
...
parser.add_argument("--batch_size", help="batch size", type=float, default=32)
